...
export default function PrivacyPage() {
  return (
    <article className="container-wide py-20 max-w-3xl">
      <h1 className="text-3xl md:text-4xl font-semibold text-white tracking-tight">Privacy Policy</h1>
      ...
      <p className="text-slate-400 mt-3 leading-relaxed">
        For privacy questions, email <a className="underline text-cyan-300 hover:text-white transition-colors" href="mailto:sales@nexatel.org">sales@nexatel.org</a>.
      </p>
    </article>
  );
}
